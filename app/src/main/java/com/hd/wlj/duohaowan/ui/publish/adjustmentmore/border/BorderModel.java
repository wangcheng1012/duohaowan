...
public class BorderModel extends BaseAsyncModle {
    ...
    private String backgroundWall_id;
    ...
    public void addRequestParemeter(AsyncRequestModle asRequestModle, int type) throws IOException {
        if (type == type_border_bili) {
            ...
            httpPost.addParemeter("backgroundWall_id", backgroundWall_id);
    ...
    public void setBackgroundWall_id(String backgroundWall_id) {
        this.backgroundWall_id = backgroundWall_id;
    }
}
