package com.hd.wlj.duohaowan.ui.home.classify.detailswork;
...
import com.hd.wlj.duohaowan.ui.home.classify.detailswork.presenter.DetailsPresenterImpl;
...
public class WorkDetailsActivity extends BaseFragmentActivity implements DetailsContract.View, View.OnClickListener {
    ...
    private void show(String json) {
        try {
            ...
            LoadImage.getinstall().addTask(Urls.HOST + jo.optString("pic"), holder.img);
