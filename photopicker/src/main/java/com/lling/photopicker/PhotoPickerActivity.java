...
public class PhotoPickerActivity extends Activity implements PhotoAdapter.PhotoClickCallBack {
    ...
    public final static String KEY_RESULT_URLSTR = "picker_result_URL";
    ...
    private ArrayList<String> mSelectListUri = new ArrayList<>();
    ...
    private void selectPhoto(Photo photo) {
        ...
        if (mSelectMode == MODE_SINGLE) {
            ...
            mSelectListUri.add(photo.getUri());
            returnData();
        }
    }
    ...
    private void returnData() {
        ...
        data.putStringArrayListExtra(KEY_RESULT_URLSTR, mSelectListUri);
...
//                .setRationalBtn()*/
            ...
            public void onDenied(List<String> permissions) {
                ...
                UIHelper.toastMessage(PhotoPickerActivity.this, permissions.toString() + "权限拒绝");
            }
        });
        ...
        if (requestCode == REQUEST_CAMERA) {
            if (resultCode == Activity.RESULT_OK) {
                if (mTmpFile != null) {
                    ...
                    mSelectListUri.add("file://" + mTmpFile.getAbsolutePath());
                    returnData();
                }
            } else {
