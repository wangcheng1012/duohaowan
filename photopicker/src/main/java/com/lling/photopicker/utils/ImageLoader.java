...
public class ImageLoader {
    ...
    public static synchronized ImageLoader getInstance(Context mContext) {

        if (mInstance == null) {
            mInstance = new ImageLoader(mContext);
        }
        return mInstance;
    }
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case 1:
                        ...
                        Bitmap bit = holder1.bitmap;
                        mbackBitmap.back(bit);
    ...
    public void getBitmap(String path, int width, int height, BackBitmap mbackBitmap) {
...
//        Logger.i(i+"   sdklsdjf");
    ...
    public class BitmapLoadTask2 extends AsyncTask<Integer, Object, Bitmap> {

        private final String path;

        public BitmapLoadTask2(String path) {
            if (path == null) {
                throw new IllegalArgumentException("args may not be null");
            }
            this.path = path;
